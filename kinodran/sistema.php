<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM clientess3 WHERE id LIKE '%$data%' or nome LIKE '%$data%' or email LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
        $sql = "SELECT * FROM clientess3 ORDER BY id DESC";
    }
...
<body>
    ...
    <div class="m-5"style="overflow-x:auto;">
